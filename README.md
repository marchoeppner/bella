...
BELLA is primarily meant to be used with foodborne pathogens, such as *E. coli*, *Listeria monocytogenes* and *Salmonella enteria* (i.e. it comes with allele schemas for these three species). Other species are supported of course, if you provide a compatible schema database (Chewbbaca v3.3x).

For more information, please check out the documentation below. 
